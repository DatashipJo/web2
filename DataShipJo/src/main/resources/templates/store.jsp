<html>
  <head>
   ...
   body{
	...
	<script>
	function store()
		var serData = $('#detail').serialize();
		//alert('form data: '+ serData);
		$a.jax({
			url:'detail.jsp',
			method:'post',
			cache:false,
...
//String sql = SELECT * FROM ck_store WHERE id = ###; — ### = 링크에서 받아올 id 값 하빈스가 줘야 할거!
			//SELECT * FROM ck_review WHERE id = ###; — ### = 링크에서 받아올 id 값 하빈스가 줘야 할거! 리뷰 부분 공동 작업할꺼~
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="../images/head.png" alt="image" />
                              <span class="pl-2">@이0후</span>
                            </td>
                            <td> 4.2 </td>
                            <td> 전체적으로 만족스러웠습니다 </td>
                            <td> 　  </td>
                            <td> 　   </td>
                          </tr>
                          <tr>
                          	<td>
                              <img src="../images/head.png" alt="image" />
                              <span class="pl-2">@김0성</span>
                            </td>
                            <td> 4.8 </td>
                            <td> 항상 배달도 빠르고 맛있어요 </td>
                            <td> 　   </td>
                            <td> 　   </td>
                          </tr>
                          <tr>
